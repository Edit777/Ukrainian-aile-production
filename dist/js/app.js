(() => {
    ...
    da.init();
    const searchBody = document.querySelector(".header-content__search-box");
    const inputSearch = document.querySelector(".sub-search");
    document.addEventListener("click", search);
    function search(event) {
        if (event.target.closest(".header-content__search")) {
            searchBody.classList.add("header-content__search-box_active");
            inputSearch.focus();
        }
